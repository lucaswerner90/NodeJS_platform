...
class User {
  ...
  */
  get_user_info() {
    ...
    const _self = this;
    return new Promise((resolve, reject) => {
      _self._microservice_client.send_query(_self._common_queries.GET.user_info, {
  ...
  */
  get_catalogo_image(id_contenido) {
    ...
    const _self = this;
    return new Promise((resolve, reject) => {
      _self._microservice_client.send_query(_self._common_queries.GET.catalogo_image, {
          id_contenido
        }).then((data) => {
          resolve(data[0]);
        })
  ...
  */
  get_content_by_id(id_contenido) {
    ...
    return new Promise((resolve, reject) => {
      let arrayPromises = [];
      arrayPromises.push(_self._microservice_client.send_query(_self._common_queries.GET.content_id, {
        id_contenido: id_contenido
      }));
      arrayPromises.push(_self._microservice_client.send_query(_self._common_queries.GET.tableOfCompatibilities, {
        id_contenido: id_contenido
      }));
      arrayPromises.push(_self._microservice_client.send_query(_self._common_queries.GET.content_platforms, {
        id_contenido: id_contenido
      }));
      arrayPromises.push(_self._microservice_client.send_query(_self._common_queries.GET.content_servers, {
        id_contenido: id_contenido
      }));
      arrayPromises.push(_self._microservice_client.send_query(_self._common_queries.GET.content_recursos, {
        id_contenido: id_contenido
      }));
      arrayPromises.push(_self._microservice_client.send_query(_self._common_queries.GET.content_categorias_subcategorias, {
        id_contenido: id_contenido
      }));
      arrayPromises.push(_self._microservice_client.send_query(_self._common_queries.GET.content_licencias, {
        id_contenido: id_contenido
      }));
  ...
  */
  get_avatar(filename) {
    const _self = this;
    return new Promise((resolve, reject) => {
      _self._file.downloadImageInBase64(filename)
        .then((data) => {
          resolve(data);
        })
        .catch((err) => {
